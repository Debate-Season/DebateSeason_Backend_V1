...
public class MediaManagerV1Test {
	...
	public void demoGetMultiMedia(){
		...
		Media dummyMediaJpaEntity1 = initMediaJpaEntity1(now);
		Media dummyMediaJpaEntity2 = initMediaJpaEntity2(now);
		MediaType mediaType = MediaType.Normal_Media;


		List<Media> multiMediaJpaEntity = new ArrayList<>();
		multiMediaJpaEntity.add(dummyMediaJpaEntity1);
		multiMediaJpaEntity.add(dummyMediaJpaEntity2);

		// when
		List<Object> result = mediaManager.getMultiMedia(multiMediaJpaEntity,mediaType);
	...
	public Media initMediaJpaEntity1(LocalDateTime now){
	...
	public Media initMediaJpaEntity2(LocalDateTime now){
		return Media.builder()
			.id(1L)
	...
	public void shouldMatchFieldsOfMediaJpaEntity(MediaResponse element1, Media dummyMediaJpaEntity){
