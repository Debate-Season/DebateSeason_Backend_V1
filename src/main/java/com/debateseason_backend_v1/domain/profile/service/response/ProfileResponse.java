...
public record ProfileResponse(
	...
	public static ProfileResponse of(Profile profile, CommunityType communityType) {
		...
		return ProfileResponse.builder()
			...
			.nickname(profile.getPersonalInfo().getNickname())
			.gender(profile.getPersonalInfo().getGender())
			.ageRange(profile.getPersonalInfo().getAgeRange())
			.residenceProvince(profile.getPersonalInfo().getResidence().getProvinceType().getCode())
			.residenceDistrict(profile.getPersonalInfo().getResidence().getDistrictType().getCode())
			.hometownProvince(profile.getPersonalInfo().getHometown().getProvinceType().getCode())
			.hometownDistrict(profile.getPersonalInfo().getHometown().getDistrictType().getCode())
