...
public interface ProfileControllerV1Docs {
	...
	@ApiErrorCode({
		...
		ErrorCode.MISSING_REQUIRED_RESIDENCE_PROVINCE,
		ErrorCode.MISSING_REQUIRED_RESIDENCE_DISTRICT,
		ErrorCode.MISSING_REQUIRED_HOMETOWN_PROVINCE,
		ErrorCode.MISSING_REQUIRED_HOMETOWN_DISTRICT,
		ErrorCode.NOT_SUPPORTED_COMMUNITY,
		ErrorCode.NOT_SUPPORTED_GENDER_TYPE,
		ErrorCode.NOT_SUPPORTED_AGE_RANGE,
		ErrorCode.NOT_SUPPORTED_PROVINCE,
		ErrorCode.NOT_SUPPORTED_DISTRICT,
		ErrorCode.INVALID_DISTRICT_PROVINCE_RELATION,
	})
