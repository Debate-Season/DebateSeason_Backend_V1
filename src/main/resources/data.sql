...
VALUES ('윤석열 정부 비상계엄', '2024-12-03 08:51:57.381201'),
       ...
       ('2024년 미국 대통령 선거', '2024-01-23 08:56:30.820470'),
       ('제주항공 2216편 활주로 이탈 사고', '2024-12-29 08:57:28.880345');

INSERT INTO chat_room (issue_id, title, content, created_at)
VALUES (1, '비상계엄 선포의 정당성', 'string', '2024-12-03 08:51:57.381201'),
       (1, '비상계엄 해제 이후의 대통령 책임', 'string.', '2024-12-03 08:52:27.692735'),
       (1, '국회의 정부 견제 방식의 적절성', 'string', '2024-12-03 08:52:46.590000'),
       ...
       (3, 'HYBE의 향후 전망', 'string', '2024-04-25 08:54:56.143396'),
       (3, 'HYBE의 감사 착수 정당성', 'string', '2024-04-25 08:55:34.303370'),
       (3, '민희진 대표의 기자회견 태도', 'string', '2024-04-25 08:55:46.699187'),
       (3, 'ADOR의 독립성 보장', 'string', '2024-04-25 08:56:02.933993'),
       (4, '경제 정책 방향', 'string', '2024-01-23 08:56:30.820470'),
       (4, '이민 정책', 'string', '2024-01-23 08:56:38.637825'),
       (4, '기후 변화 대응', 'string', '2024-01-23 08:56:46.493262'),
       (5, '활로를 착륙 지점의 적절성', 'string', '2024-12-29 08:57:28.880345'),
       (5, '조류 충돌 경보 대응의 적절성', 'string', '2024-12-29 08:57:49.313369'),
       (5, '동체 착륙 결정의 타당성', 'string', '2024-12-29 08:58:01.460832');