...
public class MediaService {
	...
	public ApiResult<MediaContainer> fetch(String type, String time){
		...
		// 2. 최신 미디어 1건 가져오기
		Media findLatestMediaJpaEntity = mediaRepository.findSingleLatestNews();// Repository
		MediaResponse mostRecentMedia = mediaManager.getSingleMedia(findLatestMediaJpaEntity);
